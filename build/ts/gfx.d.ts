...
declare module Shumway.Remoting.GFX {
    ...
    class GFXChannelDeserializerContext implements IVideoPlaybackEventSerializer {
        ...
        registerImage(syncId: number, symbolId: number, imageType: ImageType, data: Uint8Array, resolve: (data: any) => void): void;
...
declare module Shumway.GFX {
    ...
    class EaselHost {
        ...
        processRegisterImage(syncId: number, symbolId: number, imageType: ImageType, data: Uint8Array, resolve: (data: any) => void): void;
...
declare module Shumway.GFX.Test {
    ...
    class MovieRecorder {
        ...
        recordImage(syncId: number, symbolId: number, imageType: ImageType, data: Uint8Array): void;
