            ...
            var PlayerChannelSerializer = (function () {
                ...
                PlayerChannelSerializer.prototype.writeStage = function (stage, currentMouseTarget) {
                    ...
                    if (currentMouseTarget) {
                        ...
                        if (cursor === MouseCursor.AUTO) {
                            ...
                            do {
                                if (stage.sec.flash.display.SimpleButton.axClass.axIsType(node) || (stage.sec.flash.display.Sprite.axClass.axIsType(node) && node.buttonMode) && currentMouseTarget.useHandCursor) {
                ...
                PlayerChannelSerializer.prototype._writeFilters = function (filters) {
                    ...
                    for (var i = 0; i < filters.length; i++) {
                        if (blurFilterClass.axIsType(filters[i]) || dropShadowFilterClass.axIsType(filters[i]) || glowFilterClass.axIsType(filters[i])) {
                            count++;
                        }
                        else {
...
(function (Shumway) {
    ...
    (function (_Player) {
        ...
        var GFXServiceBase = (function () {
            ...
            GFXServiceBase.prototype.registerImage = function (syncId, symbolId, imageType, data) {
                throw new Error('This method is abstract');
            };
         ...
         */
        var Player = (function () {
            function Player(sec, gfxService, env) {
            ...
            Player.prototype.load = function (url, buffer) {
                ...
                this.addToSWFLoadingWhitelist(Shumway.FileLoadingService.instance.resolveUrl(url), false);
            ...
            Player.prototype.registerImage = function (symbol, imageType, data) {
                release || assert(symbol.syncId);
                symbol.resolveAssetPromise = new Shumway.PromiseWrapper(); // TODO no need for wrapper here, change to Promise
            ...
            Player.prototype.addToSWFLoadingWhitelist = function (domain, insecure) {
                if (domain.indexOf('/') < 0) {
    ...
    (function (Player) {
        ...
        (function (Window) {
            ...
            var WindowGFXService = (function (_super) {
                ...
                function WindowGFXService(sec, window, parent) {
                ...
                WindowGFXService.prototype.registerImage = function (syncId, symbolId, imageType, data) {
                    var requestId = this._assetDecodingRequests.length;
                    var result = new Shumway.PromiseWrapper();
                    this._assetDecodingRequests[requestId] = result;
                    var message = {
    ...
    (function (Player) {
        ...
        (function (Test) {
            ...
            var TestGFXService = (function (_super) {
                ...
                TestGFXService.prototype.registerImage = function (syncId, symbolId, imageType, data) {
                    var requestId = this._assetDecodingRequests.length;
                    var result = new Shumway.PromiseWrapper();
                    this._assetDecodingRequests[requestId] = result;
                    var message = {
