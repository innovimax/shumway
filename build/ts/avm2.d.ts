...
declare module Shumway.AVMX {
    ...
    class RuntimeTraits {
        traits: RuntimeTraitInfo[];
        superTraits: RuntimeTraits;
        protectedNs: Namespace;
        protectedNsMappings: any;
        slots: RuntimeTraitInfo[];
        private _nextSlotID;
        constructor(traits: RuntimeTraitInfo[], superTraits: RuntimeTraits, protectedNs: Namespace, protectedNsMappings: any);
        addSlotTrait(trait: RuntimeTraitInfo): void;
        /**
         * Searches for a trait with the specified name.
         */
        indexOf(nss: Namespace[], mnName: string): number;
    ...
    class Namespace {
        ...
        constructor(abc: ABCFile, type: NamespaceType, uri: string);
        toString(): string;
        ...
        static STATIC_PROTECTED: Namespace;
...
declare module Shumway.AVMX.AS {
    ...
    function isXMLCollection(val: any, sec: AXSecurityDomain): boolean;
